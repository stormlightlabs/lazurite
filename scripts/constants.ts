...
export const IOS_SIZES = [
  ...
  { name: "Default-Portrait-812h@3x", size: 1125, scale: 3, height: 2436 }, // iPhone X
  { name: "Default-Landscape-812h@3x", size: 2436, scale: 3, height: 1125 },
  { name: "Default-Portrait-896h@3x", size: 828, scale: 3, height: 1792 }, // iPhone XR
  { name: "Default-Landscape-896h@3x", size: 1792, scale: 3, height: 828 },
  { name: "Default-Portrait-926h@3x", size: 1170, scale: 3, height: 2532 }, // iPhone 12/13/14
  { name: "Default-Landscape-926h@3x", size: 2532, scale: 3, height: 1170 },
  { name: "Default-Portrait-932h@3x", size: 1179, scale: 3, height: 2556 }, // iPhone 14 Pro
