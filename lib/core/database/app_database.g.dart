...
class Account extends DataClass implements Insertable<Account> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (!nullToAbsent || oauthClientId != null) {
      map['oauth_client_id'] = Variable<String>(oauthClientId);
    }
    if (!nullToAbsent || oauthTokenType != null) {
      map['oauth_token_type'] = Variable<String>(oauthTokenType);
    }
    if (!nullToAbsent || oauthScope != null) {
      map['oauth_scope'] = Variable<String>(oauthScope);
    }
  ...
  factory Account.fromJson(
    ...
    return Account(
      ...
      oauthClientId: serializer.fromJson<String?>(json['oauthClientId']),
      oauthTokenType: serializer.fromJson<String?>(json['oauthTokenType']),
      oauthScope: serializer.fromJson<String?>(json['oauthScope']),
  ...
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      ...
      'oauthClientId': serializer.toJson<String?>(oauthClientId),
      'oauthTokenType': serializer.toJson<String?>(oauthTokenType),
      'oauthScope': serializer.toJson<String?>(oauthScope),
  ...
  Account copyWith({
    ...
    Value<String?> oauthClientId = const Value.absent(),
    Value<String?> oauthTokenType = const Value.absent(),
    Value<String?> oauthScope = const Value.absent(),
    String? accessToken,
  ...
  String toString() {
    return (StringBuffer('Account(')
          ...
          ..write('oauthClientId: $oauthClientId, ')
          ..write('oauthTokenType: $oauthTokenType, ')
          ..write('oauthScope: $oauthScope, ')
  ...
  bool operator ==(Object other) =>
      ...
      (other is Account &&
          ...
          other.oauthClientId == this.oauthClientId &&
          other.oauthTokenType == this.oauthTokenType &&
          other.oauthScope == this.oauthScope &&
...
class AccountsCompanion extends UpdateCompanion<Account> {
  ...
  final Value<String?> oauthClientId;
  final Value<String?> oauthTokenType;
  final Value<String?> oauthScope;
  ...
  const AccountsCompanion({
    ...
    this.oauthClientId = const Value.absent(),
    this.oauthTokenType = const Value.absent(),
    this.oauthScope = const Value.absent(),
  ...
  static Insertable<Account> custom({
    ...
    Expression<String>? oauthClientId,
    Expression<String>? oauthTokenType,
    Expression<String>? oauthScope,
    ...
    return RawValuesInsertable({
      ...
      if (oauthTokenType != null) 'oauth_token_type': oauthTokenType,
      if (oauthScope != null) 'oauth_scope': oauthScope,
  ...
  AccountsCompanion copyWith({
    ...
    Value<String?>? oauthClientId,
    Value<String?>? oauthTokenType,
    Value<String?>? oauthScope,
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (oauthClientId.present) {
      map['oauth_client_id'] = Variable<String>(oauthClientId.value);
    }
    if (oauthTokenType.present) {
      map['oauth_token_type'] = Variable<String>(oauthTokenType.value);
    }
    if (oauthScope.present) {
      map['oauth_scope'] = Variable<String>(oauthScope.value);
    }
...
class $CachedFeedPostsTable extends CachedFeedPosts
  ...
  @override
  Set<GeneratedColumn> get $primaryKey => {accountDid, feedKey, postUri};
  @override
...
class $CachedThreadRootsTable extends CachedThreadRoots
  ...
  @override
  Set<GeneratedColumn> get $primaryKey => {accountDid, rootUri};
  @override
  ...
  @override
  $CachedThreadRootsTable createAlias(String alias) {
    return $CachedThreadRootsTable(attachedDatabase, alias);
  }
}
...
class CachedThreadRoot extends DataClass
  ...
  CachedThreadRootsCompanion toCompanion(bool nullToAbsent) {
    return CachedThreadRootsCompanion(
      accountDid: Value(accountDid),
  ...
  @override
  String toString() {
    return (StringBuffer('CachedThreadRoot(')
          ..write('accountDid: $accountDid, ')
  ...
  @override
  int get hashCode => Object.hash(accountDid, rootUri, payload, fetchedAt);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is CachedThreadRoot &&
          other.accountDid == this.accountDid &&
...
class CachedThreadRootsCompanion extends UpdateCompanion<CachedThreadRoot> {
  final Value<String> accountDid;
  final Value<String> rootUri;
  final Value<String> payload;
  final Value<DateTime> fetchedAt;
  final Value<int> rowid;
  const CachedThreadRootsCompanion({
    this.accountDid = const Value.absent(),
  ...
  CachedThreadRootsCompanion.insert({
    required String accountDid,
    ...
    this.rowid = const Value.absent(),
       ...
       rootUri = Value(rootUri),
       payload = Value(payload);
  static Insertable<CachedThreadRoot> custom({
    Expression<String>? accountDid,
  ...
  CachedThreadRootsCompanion copyWith({
    Value<String>? accountDid,
  ...
  @override
  String toString() {
    return (StringBuffer('CachedThreadRootsCompanion(')
          ..write('accountDid: $accountDid, ')
          ..write('rootUri: $rootUri, ')
          ..write('payload: $payload, ')
          ..write('fetchedAt: $fetchedAt, ')
...
class $DraftsTable extends Drafts with TableInfo<$DraftsTable, DraftEntry> {
  ...
  static const VerificationMeta _composePayloadJsonMeta =
      const VerificationMeta('composePayloadJson');
  @override
  late final GeneratedColumn<String> composePayloadJson =
  ...
  VerificationContext validateIntegrity(
    ...
    if (data.containsKey('compose_payload_json')) {
      context.handle(
        _composePayloadJsonMeta,
        composePayloadJson.isAcceptableOrUnknown(
          data['compose_payload_json']!,
          _composePayloadJsonMeta,
        ),
      );
    }
  ...
  DraftEntry map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return DraftEntry(
      ...
      composePayloadJson: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}compose_payload_json'],
      ),
      createdAt: attachedDatabase.typeMapping.read(
        DriftSqlType.dateTime,
        data['${effectivePrefix}created_at'],
...
class DraftEntry extends DataClass implements Insertable<DraftEntry> {
  ...
  final String? composePayloadJson;
  final DateTime createdAt;
  final DateTime updatedAt;
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (!nullToAbsent || composePayloadJson != null) {
      map['compose_payload_json'] = Variable<String>(composePayloadJson);
    }
    map['created_at'] = Variable<DateTime>(createdAt);
    map['updated_at'] = Variable<DateTime>(updatedAt);
  ...
  DraftsCompanion toCompanion(bool nullToAbsent) {
    return DraftsCompanion(
      ...
      mediaPaths: mediaPaths == null && nullToAbsent
          ? const Value.absent()
          : Value(mediaPaths),
      composePayloadJson: composePayloadJson == null && nullToAbsent
          ? const Value.absent()
          : Value(composePayloadJson),
      createdAt: Value(createdAt),
      updatedAt: Value(updatedAt),
  ...
  factory DraftEntry.fromJson(
    ...
    return DraftEntry(
      ...
      composePayloadJson: serializer.fromJson<String?>(
        json['composePayloadJson'],
      ),
      createdAt: serializer.fromJson<DateTime>(json['createdAt']),
      updatedAt: serializer.fromJson<DateTime>(json['updatedAt']),
  ...
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      ...
      'composePayloadJson': serializer.toJson<String?>(composePayloadJson),
      'createdAt': serializer.toJson<DateTime>(createdAt),
      'updatedAt': serializer.toJson<DateTime>(updatedAt),
  ...
  DraftEntry copyWith({
    ...
    Value<String?> composePayloadJson = const Value.absent(),
    DateTime? createdAt,
    DateTime? updatedAt,
    ...
    composePayloadJson: composePayloadJson.present
        ? composePayloadJson.value
        : this.composePayloadJson,
    createdAt: createdAt ?? this.createdAt,
    updatedAt: updatedAt ?? this.updatedAt,
  ...
  DraftEntry copyWithCompanion(DraftsCompanion data) {
    return DraftEntry(
      ...
      mediaPaths: data.mediaPaths.present
          ...
          : this.mediaPaths,
      composePayloadJson: data.composePayloadJson.present
          ? data.composePayloadJson.value
          : this.composePayloadJson,
      createdAt: data.createdAt.present ? data.createdAt.value : this.createdAt,
      updatedAt: data.updatedAt.present ? data.updatedAt.value : this.updatedAt,
  ...
  String toString() {
    return (StringBuffer('DraftEntry(')
          ...
          ..write('composePayloadJson: $composePayloadJson, ')
          ..write('createdAt: $createdAt, ')
          ..write('updatedAt: $updatedAt, ')
  ...
  bool operator ==(Object other) =>
      ...
      (other is DraftEntry &&
          ...
          other.composePayloadJson == this.composePayloadJson &&
          other.createdAt == this.createdAt &&
          other.updatedAt == this.updatedAt &&
...
class DraftsCompanion extends UpdateCompanion<DraftEntry> {
  ...
  final Value<String?> composePayloadJson;
  final Value<DateTime> createdAt;
  final Value<DateTime> updatedAt;
  ...
  const DraftsCompanion({
    ...
    this.composePayloadJson = const Value.absent(),
    this.createdAt = const Value.absent(),
    this.updatedAt = const Value.absent(),
  ...
  static Insertable<DraftEntry> custom({
    ...
    Expression<String>? composePayloadJson,
    Expression<DateTime>? createdAt,
    Expression<DateTime>? updatedAt,
    ...
    return RawValuesInsertable({
      ...
      if (composePayloadJson != null)
        'compose_payload_json': composePayloadJson,
      if (createdAt != null) 'created_at': createdAt,
      if (updatedAt != null) 'updated_at': updatedAt,
  ...
  DraftsCompanion copyWith({
    ...
    Value<String?>? composePayloadJson,
    Value<DateTime>? createdAt,
    Value<DateTime>? updatedAt,
    ...
    return DraftsCompanion(
      ...
      composePayloadJson: composePayloadJson ?? this.composePayloadJson,
      createdAt: createdAt ?? this.createdAt,
      updatedAt: updatedAt ?? this.updatedAt,
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (composePayloadJson.present) {
      map['compose_payload_json'] = Variable<String>(composePayloadJson.value);
    }
    if (createdAt.present) {
      map['created_at'] = Variable<DateTime>(createdAt.value);
    }
...
class $LikedPostsTable extends LikedPosts
  ...
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  $LikedPostsTable(this.attachedDatabase, [this._alias]);
  static const VerificationMeta _idMeta = const VerificationMeta('id');
  @override
  late final GeneratedColumn<int> id = GeneratedColumn<int>(
    'id',
  ...
  @override
  $LikedPostsTable createAlias(String alias) {
    return $LikedPostsTable(attachedDatabase, alias);
  }
}

class LikedPostEntry extends DataClass implements Insertable<LikedPostEntry> {
  final int id;
  final String accountDid;
  final String postUri;
  final String postJson;
  final DateTime likedAt;
  const LikedPostEntry({
    required this.id,
    required this.accountDid,
    required this.postUri,
    required this.postJson,
  ...
  LikedPostsCompanion toCompanion(bool nullToAbsent) {
    return LikedPostsCompanion(
      id: Value(id),
      accountDid: Value(accountDid),
      postUri: Value(postUri),
      postJson: Value(postJson),
  ...
  @override
  String toString() {
    return (StringBuffer('LikedPostEntry(')
          ..write('id: $id, ')
          ..write('accountDid: $accountDid, ')
          ..write('postUri: $postUri, ')
          ..write('postJson: $postJson, ')
  ...
  @override
  int get hashCode => Object.hash(id, accountDid, postUri, postJson, likedAt);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is LikedPostEntry &&
          other.id == this.id &&
          other.accountDid == this.accountDid &&
          other.postUri == this.postUri &&
          other.postJson == this.postJson &&
...
class LikedPostsCompanion extends UpdateCompanion<LikedPostEntry> {
  final Value<int> id;
  final Value<String> accountDid;
  final Value<String> postUri;
  final Value<String> postJson;
  final Value<DateTime> likedAt;
  const LikedPostsCompanion({
    this.id = const Value.absent(),
    this.accountDid = const Value.absent(),
    this.postUri = const Value.absent(),
    this.postJson = const Value.absent(),
  ...
  LikedPostsCompanion.insert({
    ...
    this.likedAt = const Value.absent(),
       ...
       postUri = Value(postUri),
       postJson = Value(postJson);
  static Insertable<LikedPostEntry> custom({
    Expression<int>? id,
    Expression<String>? accountDid,
    Expression<String>? postUri,
    Expression<String>? postJson,
  ...
  @override
  String toString() {
    return (StringBuffer('LikedPostsCompanion(')
          ..write('id: $id, ')
          ..write('accountDid: $accountDid, ')
          ..write('postUri: $postUri, ')
          ..write('postJson: $postJson, ')
...
typedef $$CachedFeedPostsTableProcessedTableManager =
    ProcessedTableManager<
      ...
      PrefetchHooks Function()
    >;
typedef $$CachedThreadRootsTableCreateCompanionBuilder =
    CachedThreadRootsCompanion Function({
      required String accountDid,
      required String rootUri,
      required String payload,
      Value<DateTime> fetchedAt,
...
typedef $$CachedThreadRootsTableUpdateCompanionBuilder =
    CachedThreadRootsCompanion Function({
      Value<String> accountDid,
      Value<String> rootUri,
      Value<String> payload,
...
typedef $$CachedThreadRootsTableProcessedTableManager =
    ProcessedTableManager<
      _$AppDatabase,
      $CachedThreadRootsTable,
      CachedThreadRoot,
...
class $$DraftsTableFilterComposer
  ...
  ColumnFilters<String> get composePayloadJson => $composableBuilder(
    column: $table.composePayloadJson,
    builder: (column) => ColumnFilters(column),
  );
...
class $$DraftsTableOrderingComposer
  ...
  ColumnOrderings<String> get composePayloadJson => $composableBuilder(
    column: $table.composePayloadJson,
    builder: (column) => ColumnOrderings(column),
  );
...
class $$DraftsTableAnnotationComposer
  ...
  GeneratedColumn<String> get composePayloadJson => $composableBuilder(
    column: $table.composePayloadJson,
    builder: (column) => column,
  );
        ...
        TableManagerState(
          ...
          updateCompanionCallback:
              ({
                ...
                composePayloadJson: composePayloadJson,
                createdAt: createdAt,
                updatedAt: updatedAt,
...
typedef $$LikedPostsTableUpdateCompanionBuilder =
    LikedPostsCompanion Function({
      Value<int> id,
      Value<String> accountDid,
      Value<String> postUri,
...
class $$LikedPostsTableTableManager
    extends
        RootTableManager<
          ...
          PrefetchHooks Function()
        > {
  $$LikedPostsTableTableManager(_$AppDatabase db, $LikedPostsTable table)
    : super(
        TableManagerState(
          db: db,
          table: table,
...
typedef $$LikedPostsTableProcessedTableManager =
    ProcessedTableManager<
      _$AppDatabase,
      $LikedPostsTable,
      LikedPostEntry,
