...
class _NotificationsScreenState extends State<NotificationsScreen> {
          ...
          return RefreshIndicator(
            ...
            child: ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                } else if (item is bsky.Notification) {
  ...
  Map<DateTime, List<bsky.Notification>> _groupNotificationsByDay(List<bsky.Notification> notifications) {
    final grouped = <DateTime, List<bsky.Notification>>{};
  ...
  int _calculateItemCount(Map<DateTime, List<bsky.Notification>> grouped, NotificationState state) {
    int count = 0;
  ...
  dynamic _getItemAtIndex(Map<DateTime, List<bsky.Notification>> grouped, int index) {
    int currentIndex = 0;
